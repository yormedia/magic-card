...
const formatDateWeekdayMem = (locale: FrontendLocaleData) =>
...
const formatDateMem = (locale: FrontendLocaleData) =>
  new Intl.DateTimeFormat(locale.language, {
    year: "numeric",
    month: "long",
    day: "numeric",
...
const formatDateNumericMem = (locale: FrontendLocaleData) =>
  new Intl.DateTimeFormat(locale.language, {
    year: "numeric",
    month: "numeric",
    day: "numeric",
...
const formatDateShortMem = (locale: FrontendLocaleData) =>
  new Intl.DateTimeFormat(locale.language, {
    day: "numeric",
    month: "short",
  });
