...
const formatTimeMem = (locale: FrontendLocaleData) =>
...
const formatTimeWithSecondsMem = (locale: FrontendLocaleData) =>
  new Intl.DateTimeFormat(locale.language, {
...
const formatTimeWeekdayMem = (locale: FrontendLocaleData) =>
  new Intl.DateTimeFormat(locale.language, {
    hour: useAmPm(locale) ? "numeric" : "2-digit",
    minute: "2-digit",
    second: "2-digit",
