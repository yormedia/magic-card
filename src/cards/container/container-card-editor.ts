...
export class MagicContainerCardEditor extends MagicBaseElement implements LovelaceCardEditor {
    @state() private _config?: MagicContainerCardConfig;
    ...
    public setConfig(config: MagicContainerCardConfig): void {
        this._config = config;
