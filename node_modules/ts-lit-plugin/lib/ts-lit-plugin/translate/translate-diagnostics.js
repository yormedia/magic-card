...
function translateDiagnostic(diagnostic, file, context) {
    var _a;
    var span = translate_range_1.translateRange(diagnostic.location);
    ...
    return __assign(__assign({}, span), { file: file,
        messageText: messageText,
        category: category,
        code: code, source: diagnostic.source == null ? undefined : "lit-plugin(" + diagnostic.source + ")" });
}
