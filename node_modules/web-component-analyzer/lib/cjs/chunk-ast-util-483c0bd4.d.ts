...
import { Declaration, Decorator, Identifier, InterfaceDeclaration, Node, PropertyDeclaration, PropertySignature, SetAccessorDeclaration, Symbol, SyntaxKind, TypeChecker } from "typescript";
 ...
 * @param context
 */
declare function getSymbol(node: Node, context: {
    checker: TypeChecker;
    ts: typeof tsModule;
}): Symbol | undefined;
/**
 ...
 * @param symbol
 */
declare function resolveSymbolDeclarations(symbol: Symbol): Declaration[];
/**
 * Resolve a declaration by trying to find the real value by following assignments.
 * @param node
 * @param context
 */
declare function resolveDeclarationsDeep(node: Node, context: {
    checker: TypeChecker;
    ts: typeof tsModule;
}): Node[];
/**
 ...
 * @param context
 */
declare function getNodeName(node: Node, context: {
    ts: typeof tsModule;
}): string | undefined;
/**
 * Returns the declaration name of a given node if possible.
 ...
 * @param context
 */
declare function getNodeIdentifier(node: Node, context: {
    ts: typeof tsModule;
