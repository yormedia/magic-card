...
var common = {
	version: "Versie",
	invalid_configuration: "Configuratie niet correct",
	show_warning: "Geef Waarschuwing weer",
	show_error: "Geef foutmedling weer"
};
var nl = {
	common: common
};
...
let MagicCard = class MagicCard extends s {
    static async getConfigElement() {
        await import('./magic-card-editor-7de4a85d.js');
        return document.createElement(card.editor.type);
    }
        ...
        return x `
            <ha-card header="${this.config.name || ""}">
                <div class="card-content">
                    ${this.config.show.name ? x ` <div class="name">${state.attributes.friendly_name || state.entity_id}</div> ` : ""}
                    ${this.config.show.state ? x ` <div class="state">${state.state}</div> ` : ""}
                </div>
            </ha-card>
        `;
    }
...
__decorate([
    n$1()
], MagicCard.prototype, "config", void 0);
__decorate([
    n$1({ attribute: false })
], MagicCard.prototype, "hass", void 0);
MagicCard = __decorate([
    e$1(card.type)
], MagicCard);
...
// );
console.info(`%c 🪄 %c Magic Card %c v${appInfo.version} `, "background-color: white;color: #fff;padding: 3px 2px 3px 3px;border-radius: 14px 0 0 14px;font-family: DejaVu Sans,Verdana,Geneva,sans-serif;text-shadow: 0 1px 0 rgba(1, 1, 1, 0.3)", "background-color: orange;color: white;padding: 3px 3px 3px 2px;border-radius: 0 0 0 0;font-family: DejaVu Sans,Verdana,Geneva,sans-serif;text-shadow: 0 1px 0 rgba(1, 1, 1, 0.3)", "background-color: black;color: white;padding: 3px 3px 3px 2px;border-radius: 0 14px 14px 0;font-family: DejaVu Sans,Verdana,Geneva,sans-serif;text-shadow: 0 1px 0 rgba(1, 1, 1, 0.3)");

export { MagicCard as M, S$1 as S, __decorate as _, e$1 as e, getCardData as g, i$2 as i, n$1 as n, s, x };
