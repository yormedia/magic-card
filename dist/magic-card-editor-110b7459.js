import { n, S, g as getCardData, x, i, _ as __decorate, e as e$1, s } from './index-28a42a91.js';
        ...
        return x `
            ...
            return x `<md-list-item .value=${entity}>${entity}</md-list-item>`;
                    ...
                    <md-formfield .label=${`Toggle warning ${this._show_name ? "off" : "on"}`}>
                        <md-switch .checked=${this._show_name} .configValue=${"show_warning"} @change=${this._valueChanged}></md-switch>
                    </md-formfield>
                    <md-formfield .label=${`Toggle error ${this._show_state ? "off" : "on"}`}>
                        <md-switch .checked=${this._show_state} .configValue=${"show_error"} @change=${this._valueChanged}></md-switch>
                    </md-formfield>
                </div>
            </div>
        `;
